### Trouble-shooting
# This script is to run plot individual dff of one SPECIFIC logfile at a time

# First, one must indicate what i, j, and k are.
# i = stim folder number
# j = JNL number within stim folder
# k = logfiles number within JNL folder
